/*
  ...
  1. New Tables
    - `published_models`
      - Core model metadata and publishing information
      - Validation status and requirements tracking
      - Sample data and parameters storage
  ...
  2. Enhanced Schema
    - Publishing requirements tracking
...
(
  ...
  '1.2.0',
  'An AI model designed for creative writing, storytelling, and content creation. Excels at generating engaging narratives and helping with writer\'s block.',
  'Creative Writing',
  ARRAY['creative-writing', 'storytelling', 'content-creation', 'narrative'],
  'Creative Commons',
  'You are a creative writing companion with expertise in storytelling, character development, and narrative structure. Help users craft compelling stories, overcome writer\'s block, and explore creative ideas. Be imaginative while maintaining literary quality.',
  0.9,
  0.95,
  2048,
  'approved',
