/*
  ...
  1. New Data
    - Insert 6 sample GPTs into published_models table
    - Add sample prompts for each GPT
    - Create validation records with realistic scores
    - Add download logs for usage statistics
    - Insert user ratings and reviews

  2. Sample GPTs
    - General Assistant (featured)
    - Creative Writer (featured) 
    - Code Assistant (featured)
    - Business Advisor
    - Educational Tutor
    - Technical Support

  3. Realistic Data
    - Accuracy scores: 88-95%
    - Download counts: 500-2,150
    - User ratings: 4.5-4.9 stars
    - Validation status: all approved
*/

-- Insert sample GPTs into published_models table (let database generate UUIDs)
...
-- Create a temporary function to get model IDs by name for inserting related data
...
-- Insert sample prompts for each GPT using the function
