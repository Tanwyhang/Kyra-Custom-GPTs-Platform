/*
  # Populate Sample GPTs in Database

  1. New Sample Data
    - 6 sample GPTs with proper UUID handling
    - Sample prompts for each GPT
    - Validation records with realistic scores
    - Download logs for usage statistics
  ...
  2. Data Structure
    ...
    - Featured GPTs for homepage display
...
-- Insert sample prompts for each GPT using the helper function
