...
import { ArrowRight, Upload, Search, Shield, TrendingUp, Users, Star, Sparkles, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <h1 className="scroll-reveal text-4xl sm:text-6xl font-bold mb-6">
              <span className="gradient-text">Discover & Share</span>
              <br />
              <span className="gradient-text-primary">AI Models</span>
            </h1>
            
            <p className="scroll-reveal text-xl text-white/70 mb-8 max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="scroll-reveal text-center glass-card rounded-2xl p-8 grain-texture">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-3xl font-bold gradient-text mb-4">
              Why Choose AI Model Hub?
            </h2>
            <p className="scroll-reveal text-xl text-white/70 max-w-3xl mx-auto">
              Built for the community, by the community. Transparent, secure, and accessible to all.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="scroll-reveal-left glass-card rounded-2xl p-8 grain-texture hover:scale-105 transition-all duration-300">
            ...
            <div className="scroll-reveal glass-card rounded-2xl p-8 grain-texture hover:scale-105 transition-all duration-300">
            ...
            <div className="scroll-reveal-right glass-card rounded-2xl p-8 grain-texture hover:scale-105 transition-all duration-300">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center mb-12">
              <div>
                ...
                <p className="scroll-reveal text-xl text-white/70">
                  Discover the most popular verified models in our community
                </p>
              </div>
              <Link
                to="/marketplace"
                className="scroll-reveal text-white/80 hover:text-white font-medium flex items-center glass-subtle px-4 py-2 rounded-xl hover:glass transition-all duration-300"
              >
                View all models
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {featuredModels.map((model, index) => (
                <Link
                  key={model.id}
                  to={`/models/${model.id}`}
                  className="scroll-reveal-scale glass-card rounded-2xl p-6 grain-texture hover:scale-105 transition-all duration-300 group"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="scroll-reveal glass-strong rounded-3xl p-12 grain-texture">
            <div className="inline-flex items-center px-4 py-2 rounded-full glass-subtle text-white/80 text-sm font-medium mb-6">
