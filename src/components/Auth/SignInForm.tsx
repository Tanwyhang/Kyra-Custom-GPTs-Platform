      ...
      <div className="max-w-md w-full space-y-8 relative">
        <div className="text-center">
          ...
          <p className="scroll-reveal text-base text-white/70">
            ...
            <Link to="/signup" className="font-semibold gradient-text-accent hover:text-white transition-colors">
              Sign up
            </Link>
          </p>
        </div>
        ...
        <div className="scroll-reveal-scale mt-8 space-y-6 glass-strong p-10 rounded-3xl grain-texture hover-glow">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 glass-subtle text-white/60 rounded-full">Or continue with email</span>
            </div>
          </div>
